...
public class ProductCategoryAssignmentDirectOtlpTest : IDisposable
{
    private readonly OtlpInstrumentation _instrumentation;
    private readonly ITestOutputHelper _output;

    public ProductCategoryAssignmentDirectOtlpTest(ITestOutputHelper output)
    {
    ...
    [Fact]
    public async Task ProductCategoryAssignment_ShouldPropagateTraceAcrossServices_DirectOtlp()
    {
        _output.WriteLine("[Direct OTLP] Starting product category assignment workflow");
        ...
        _output.WriteLine("[Direct OTLP] Complete workflow traced successfully");
    }
    ...
    activity?.SetTag("deployment.environment", "direct-otlp");

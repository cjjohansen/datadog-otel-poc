...
public class ProductCategoryAssignmentAzureAgentTest : IDisposable
{
    private readonly OtlpInstrumentation _instrumentation;
    private readonly ITestOutputHelper _output;

    public ProductCategoryAssignmentAzureAgentTest(ITestOutputHelper output)
    {
    ...
    [Fact]
    public async Task ProductCategoryAssignment_ShouldPropagateTraceAcrossServices_AzureAgent()
    {
        _output.WriteLine("[Azure Agent] Starting product category assignment workflow");
        ...
        _output.WriteLine("[Azure Agent] Complete workflow traced successfully");
    }
    ...
    activity?.SetTag("deployment.environment", "azure-agent");
